...
export default function SectionWrapper(props) {
  const { children, header, title, id } = props // Destructure props for easier access
  return (
    // Section that contains a header, title, and children components
    <section id={id} className='min-h-screen flex flex-col gap-10'>
      ...
      <div className='max-w-[800x] w-full flex flex-col mx-auto gap-10 p-4'>
        {children} {/* Render children elements here */}
      </div>
    </section>
  )
}
